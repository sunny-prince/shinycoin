...
QT_TRANSLATE_NOOP("bitcoin-core", "Generate coins (default: false)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Don't generate coins"),
QT_TRANSLATE_NOOP("bitcoin-core", "Set the number of simultaneous ramhog hashes to run.  You will need 15 GB for each thread (default: 1)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Set the number of worker threads to use for generating scratchpads (default: the number of processors)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Use the signed proof-of-work hashes (default: true)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Don't use the signed proof-of-work hashes"),    
QT_TRANSLATE_NOOP("bitcoin-core", "Mint coins (default: true)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 7801 or testnet: 7803)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Don't advertise the given IP address to other nodes"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Number of seconds to keep very misbehaving peers from reconnecting (default: 2592000)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for JSON-RPC connections on <port> (default: 7802)"),

...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. ShinyCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 10 && strncasecmp(argv[i], "shinycoin:", 10) == 0)
        {
    ...
    app.setOrganizationName("ShinyCoin");
    app.setOrganizationDomain("shinycoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("ShinyCoin-Qt-testnet");
    else
        app.setApplicationName("ShinyCoin-Qt");

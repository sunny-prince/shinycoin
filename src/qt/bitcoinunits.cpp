...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("rSHC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Shinys");
    case mBTC: return QString("Milli-Shinys (1 / 1,000)");
    case uBTC: return QString("Rustys (1 / 1,000,000)");
    default: return QString("???");
    }
}

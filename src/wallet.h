...
public:
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, int64> >& vecSend, const std::vector<std::pair<CBitcoinAddress, std::vector<CTxInfo> > >& vecTxInfos, CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet);
